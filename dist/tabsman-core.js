...
function setupNavWrappers() {
    ...
    // 包装move函数，用于交换面板DOM顺序
    navOriginals.method.move = orca.nav.move;
    orca.nav.move = function(from, to, dir) {
        navOriginals.method.move.call(this, from, to, dir);
        renderTabsByPanel({type: 'move', moveInfo: {from, to, dir}})
    }
}
